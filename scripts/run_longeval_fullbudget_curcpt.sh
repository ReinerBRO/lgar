...
LOG_FILE="logs/longeval_fullbudget_${TIMESTAMP}_${SLURM_JOB_ID}.log"
exec > "${LOG_FILE}" 2>&1
...
export LONGEVAL_ROOT=/data/user/xnie012/cache/data/longeval/evaluation
...
echo "=== LongEval fullbudget eval done ==="
